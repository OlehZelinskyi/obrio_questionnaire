...
const LogoIcon = ({
  ...
  if (theme === "dark") {
    return (
      ...
      >
        <rect x="0.5" width="15" height="16" fill="url(#pattern0_3354_317)" />
        <defs>
          <pattern
            id="pattern0_3354_317"
            patternContentUnits="objectBoundingBox"
            width="1"
            height="1"
          >
            <use
              xlinkHref="#image0_3354_317"
  ...
  return (
    <svg
      ...
      className={className}
    >
      <rect x="0.5" width="15" height="16" fill="url(#pattern0_3354_19)" />
      <defs>
        <pattern
          id="pattern0_3354_19"
          patternContentUnits="objectBoundingBox"
